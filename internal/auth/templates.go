...
<body>
    <div class="container">
        ...
        <div class="footer">
            <a href="https://www.docuseal.com/docs" target="_blank">Docs</a>
            &nbsp;·&nbsp;
            <a href="https://github.com/docusealco/docuseal" target="_blank">GitHub</a>
        </div>
    </div>
...
<body>
    <div class="container">
        ...
        <p class="footer">Auto-closing in a few seconds...</p>
    </div>
